...
def within_x(co1, co2):
    if (co1.x1 > co2.x1 and co1.x1 < co2.x2) \
            ...
            or (co2.x2 > co1.x1 and co2.x2 < co1.x2): # co2.x2 < co1.x1 or co1.x2
        return True
    else:
        return False
...
def within_y(co1, co2):
    if (co1.y1 > co2.y1 and co1.y1 < co2.y2) \
            ...
            or (co2.y2 > co1.y1 and co2.y2 < co1.y2): # co2.y2 < co1.y2かも
        return True
    else:
        return False
...
door = DoorSprite(g, PhotoImage(file="C:/Users/watoru/Desktop/stickman/door1.gif"), 45, 30, 40, 35)
